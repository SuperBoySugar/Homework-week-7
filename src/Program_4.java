 ...
 * the year is a leap year and return true if it is, otherwise return false. A year is a leap year if
 * it is divisible by 4 but not by 100, or it is divisible by 400. Example of input/Output:
