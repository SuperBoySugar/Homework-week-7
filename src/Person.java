 ...
 * person.setFirstName(""); // firstName is set to empty string person.setLastName("");
 * // lastName is set to empty string person.setAge(10); System.out.println("fullName= " + person.getFullName());
 * System.out.println("teen= " + person.isTeen()); person.setFirstName("John"); // firstName is set to John person.setAge(18);
...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        person.setFirstname("John"); // firstName is set to Emma
        person.setAge(18);
        System.out.println("fullName= " + person.getFullName());
        System.out.println("teen= " + person.isTeen());
        person.setLastname("Smith"); // lastName is set to Brown
        System.out.println("fullName= " + person.getFullName());
}
